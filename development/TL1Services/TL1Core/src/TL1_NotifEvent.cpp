...
TL1_NotifEvent::TL1_NotifEvent( TL1_Notification::TL1_NotifType theNotifType, 
                                const TL1_Response& theResponse ) :
TL1_Notification( theNotifType, theResponse )
{
}

TL1_NotifEvent::TL1_NotifEvent( const TL1_Response& theResponse ) :
TL1_Notification( TL1_Notification::EVT, theResponse )
{
}

TL1_NotifEvent::~TL1_NotifEvent()
{
}