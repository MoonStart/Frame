...
#ifndef ALM_RTRFAILUREBASE_H
#define ALM_RTRFAILUREBASE_H
...
class ALM_RtrFailureBase : public ALM_FailureBase
{
public:
    ...
    ALM_RtrFailureBase (int theIndex, bool theDefaultStatus = false );

    //Destructor for this class.
    virtual ~ALM_RtrFailureBase();
