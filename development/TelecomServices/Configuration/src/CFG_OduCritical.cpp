...
CFG_OduCritical::CFG_OduCritical(uint32 theIndex):
    CFG_Object(theIndex),
...
CFG_OduCritical::CFG_OduCritical(const CFG_OduCritical& theCfg):
    CFG_Object(theCfg.GetIndex()),
    myOduIdentifier(theCfg.myOduIdentifier),
    myInstanceObjectType(theCfg.myInstanceObjectType),
    myTxPayloadType(theCfg.myTxPayloadType),
    myGenericProvisioning(theCfg.myGenericProvisioning),
    myClockType(theCfg.myClockType),
    myTribSize(theCfg.myTribSize),
    myTribPort(theCfg.myTribPort),
    myExpSigRate(theCfg.myExpSigRate),
    myGfpTs(theCfg.myGfpTs)
{
}

CFG_OduCritical::~CFG_OduCritical(void)
{
}


bool CFG_OduCritical::operator==(const CFG_OduCritical& theCfg) const
{
    return ( (myOduIdentifier == theCfg.myOduIdentifier) &&
             (myInstanceObjectType == theCfg.myInstanceObjectType ) &&
             (myTxPayloadType == theCfg.myTxPayloadType) &&
             (myClockType == theCfg.myClockType) &&
             (myTribSize == theCfg.myTribSize) &&
...
CFG_OduCritical& CFG_OduCritical::operator=(const CFG_OduCritical& theCfg)
{
    this->myOduIdentifier = theCfg.myOduIdentifier;
    this->myInstanceObjectType = theCfg.myInstanceObjectType;
    this->myTxPayloadType = theCfg.myTxPayloadType;
    this->myClockType = theCfg.myClockType;
    this->myTribSize = theCfg.myTribSize;
    this->myTribPort = theCfg.myTribPort;
    this->myGenericProvisioning = theCfg.myGenericProvisioning;
    this->myExpSigRate = theCfg.myExpSigRate;
    this->myGfpTs = theCfg.myGfpTs;

    return *this;
}

bool CFG_OduCritical::SetOduIdentifier(CT_ODU_Identifier theOduId)
{
...
CT_ODU_Identifier CFG_OduCritical::GetOduIdentifier() const
{
...
bool CFG_OduCritical::SetOduObjectType(CT_ODU_Object_Type theOduType)
{
...
CT_ODU_Object_Type CFG_OduCritical::GetOduObjectType() const
{
    return myInstanceObjectType;
}

/*
bool CFG_OduCritical::SetOduPositionList(vector<CT_ODU_ServerID>& thePosList)
{
...
const vector<CT_ODU_ServerID>& CFG_OduCritical::GetOduPositionList()
{
    return myPositionList;
}


bool CFG_OduCritical::SetOduTcmAProcList(vector<CT_NumberOfOdus>& theProcList)
{
...
const vector<CT_NumberOfOdus>& CFG_OduCritical::GetOduTcmAProcList()
{
    return myTcmAProcList;
}


bool CFG_OduCritical::SetOduTcmBProcList(vector<CT_NumberOfOdus>& theProcList)
{
...
const vector<CT_NumberOfOdus>& CFG_OduCritical::GetOduTcmBProcList()
{
    return myTcmBProcList;
}


bool CFG_OduCritical::SetServerID(CT_ODU_ServerID theServerId)
{
...
CT_ODU_ServerID CFG_OduCritical::GetServerID() const 
{
    return myServerID;
}


bool CFG_OduCritical::SetAltServerID(CT_ODU_ServerID theServerId)
{
...
CT_ODU_ServerID CFG_OduCritical::GetAltServerID() const 
{
    return myAltServerID;
}


bool CFG_OduCritical::SetSentTrace(const CT_G709Trace& theSentTrace)
{
...
bool CFG_OduCritical::DeleteSentTrace()
{
    bool hasChanged = false;
    if (mySentTracePtr != NULL) 
    {
...
CT_G709Trace & CFG_OduCritical::GetSentTrace() const
{
    if (mySentTracePtr != NULL) 
    {
...
bool CFG_OduCritical::SetIsOduTerm(bool theIsOduTerm)
{
...
bool CFG_OduCritical::GetIsOduTerm() const
{
...
/*
bool CFG_OduCritical::SetInternalSignalingDisabled(bool theDisable)
{
    uint16 thePrevProv = myGenericProvisioning;
    if (theDisable) 
    {
...
bool CFG_OduCritical::GetInternalSignalingDisabled() const
{
    bool aSet = ((myGenericProvisioning & INT_SIG_DISABLED_ODU_GENERIC_PROV_MASK) != 0);
    return aSet;
}

bool CFG_OduCritical::SetExternalSignalingDisabled(bool theDisable)
{
    uint16 thePrevProv = myGenericProvisioning;
    if (theDisable) 
    {
...
bool CFG_OduCritical::GetExternalSignalingDisabled() const
{
...
bool CFG_OduCritical::SetForceAIS(bool theForceAIS)
{
    uint16 thePrevProv = myGenericProvisioning;
    if (theForceAIS) 
    {
...
bool CFG_OduCritical::GetForceAIS() const
{
    bool aSet = ((myGenericProvisioning & FORCE_AIS_GENERIC_PROV_MASK) != 0);
    return aSet;
}

bool CFG_OduCritical::SetForceLCK(bool theForceLCK)
{
    uint16 thePrevProv = myGenericProvisioning;
    if (theForceLCK) 
    {
...
bool CFG_OduCritical::GetForceLCK() const
{
    bool aSet = ((myGenericProvisioning & FORCE_LCK_GENERIC_PROV_MASK) != 0);
    return aSet;
}

bool CFG_OduCritical::SetForceOCI(bool theForceOCI)
{
    uint16 thePrevProv = myGenericProvisioning;
    if (theForceOCI) 
    {
...
bool CFG_OduCritical::GetForceOCI() const
{
...
bool CFG_OduCritical::SetBerSdThreshold(CT_TEL_BERLevels theBerSdThreshold)
{
...
CT_TEL_BERLevels CFG_OduCritical::GetBerSdThreshold() const
{
    return myBerSdLevel;
}

bool CFG_OduCritical::SetBerSfThreshold(CT_TEL_BERLevels theSfBerThreshold)
{
...
CT_TEL_BERLevels CFG_OduCritical::GetBerSfThreshold() const
{
    return mySfBerLevel;
}
*/

bool CFG_OduCritical::SetTxPayloadType(CT_TEL_PayloadSignalId theTxPayloadType)
{
...
CT_TEL_PayloadSignalId CFG_OduCritical::GetTxPayloadType() const
{
    return myTxPayloadType;
}

/*
bool CFG_OduCritical::SetForceInternalAIS(bool theForceInternalAIS)
{
    uint16 thePrevProv = myGenericProvisioning;
...
bool CFG_OduCritical::GetForceInternalAIS() const
{
    bool aSet = ((myGenericProvisioning & FORCE_INTERNAL_AIS_GENERIC_PROV_MASK) != 0);
    return aSet;
}

bool CFG_OduCritical::SetForceInternalLCK(bool theForceInternalLCK)
{
    uint16 thePrevProv = myGenericProvisioning;
...
bool CFG_OduCritical::GetForceInternalLCK() const
{
...
bool CFG_OduCritical::SetForceInternalOCI(bool theForceInternalOCI)
{
    uint16 thePrevProv = myGenericProvisioning;
...
bool CFG_OduCritical::GetForceInternalOCI() const
{
    bool aSet = ((myGenericProvisioning & FORCE_INTERNAL_OCI_GENERIC_PROV_MASK) != 0);
    return aSet;
}

bool CFG_OduCritical::SetBurstyBerSdIntervals(uint16 theIntervals)
{
...
uint16 CFG_OduCritical::GetBurstyBerSdIntervals() const
{
    return myBurstyBerSdIntervals;
}

bool CFG_OduCritical::SetBurstyBerSdThreshold(uint32 theThreshold)
{
...
uint32 CFG_OduCritical::GetBurstyBerSdThreshold() const
{
    return myBurstyBerSdThreshold;
}

bool CFG_OduCritical::SetProvisionningActive(bool theProvisionningActive)
{
...
bool CFG_OduCritical::GetProvisionningActive() const
{
...
/*
bool CFG_OduCritical::SetPMProfileId(CT_PMProfileTableId thePMPFId)
{
...
CT_PMProfileTableId CFG_OduCritical::GetPMProfileId() const
{
    return myPMProfileId;
}
*/

bool CFG_OduCritical::SetClockType(CT_TEL_ClkType theClockType)
{
...
CT_TEL_ClkType CFG_OduCritical::GetClockType() const
{
    return myClockType;
}

/*
bool CFG_OduCritical::SetTerminatedIndication(CT_ODU_IndicationType theTerminatedIndication)
{
...
CT_ODU_IndicationType CFG_OduCritical::GetTerminatedIndication() const
{
    return myTerminatedIndication;
}
*/

bool CFG_OduCritical::SetTribSize(CT_TEL_TS_SIZE theTribSize)
{
...
CT_TEL_TS_SIZE CFG_OduCritical::GetTribSize() const
{
    return (CT_TEL_TS_SIZE)myTribSize;
}

bool CFG_OduCritical::SetTribPort(uint8 theTribPort)
{
...
uint8 CFG_OduCritical::GetTribPort() const
{
    return myTribPort;
}

/*
bool CFG_OduCritical::SetTribAutoFallBack(bool theTribAutoFallBack)
{
    uint16 prevProv = myGenericProvisioning;
...
bool CFG_OduCritical::GetTribAutoFallBack() const
{
    bool aSet = ((myGenericProvisioning & TRIB_AUTO_FALLBACK_GENERIC_PROV_MASK) != 0);
    return aSet;
}

bool CFG_OduCritical::SetChannelIndexInAID(uint8 theChannelIndexInAID)
{
...
uint8 CFG_OduCritical::GetChannelIndexInAID() const
{
    return myChannelIndexInAID;
}

bool CFG_OduCritical::SetPathDelayEnabled(bool theEnabled)
{
    uint16 prevProv = myGenericProvisioning;
...
bool CFG_OduCritical::GetPathDelayEnabled() const
{
    bool aSet = ((myGenericProvisioning & PATH_SOURCE_DELAY_PROV_MASK) != 0);
    return aSet;
}

bool CFG_OduCritical::SetPrbsTxEnable(bool thePrbsTxEnable)
{
    uint16 prevProv = myGenericProvisioning;
...
bool CFG_OduCritical::GetPrbsTxEnable() const
{
    bool aSet = ((myGenericProvisioning & TX_PRBS_ODU_GENERIC_PROV_MASK) != 0);
    return aSet;
}

bool CFG_OduCritical::SetPrbsRxEnable(bool thePrbsRxEnable)
{
    uint16 prevProv = myGenericProvisioning;
...
bool CFG_OduCritical::GetPrbsRxEnable() const
{
    bool aSet = ((myGenericProvisioning & RX_PRBS_ODU_GENERIC_PROV_MASK) != 0);
    return aSet;
}

bool CFG_OduCritical::SetPrbsRxSessionCounter(uint32 thePrbsRxSessionCounter)
{
...
uint32 CFG_OduCritical::GetPrbsRxSessionCounter() const
{
    return myPrbsRxSessionCounter;
}

bool CFG_OduCritical::GetNULLSignalEnable() const
{
    bool aSet = ((myGenericProvisioning & NULL_SIGNAL_GENERIC_PROV_MASK) != 0);
    return aSet;
}

bool CFG_OduCritical::SetNULLSignalEnable(bool theEnable)
{
    uint16 prevProv = myGenericProvisioning;
...
bool CFG_OduCritical::SetExpectedSignalRate(uint32 theExpSigRate)
{
...
uint32 CFG_OduCritical::GetExpectedSignalRate() const
{
    return myExpSigRate;
}

bool CFG_OduCritical::SetGfpTs(uint8 theGfpTs)
{
...
uint8 CFG_OduCritical::GetGfpTs() const
{
    return myGfpTs;
}

/*
bool CFG_OduCritical::SetCrossConnectedOduIdx(uint8 theOduIdx)
{
...
uint8 CFG_OduCritical::GetCrossConnectedOduIdx() const
{
    return myCrossConnectedOduIdx;
}
*/

void CFG_OduCritical::Reset(void)
{
    myOduIdentifier = CT_DEFAULT_ODU_ID;
    myInstanceObjectType = CT_ODU_UNKNOWN_TYPE;
...
// For Display
ostream& CFG_OduCritical::WriteObject( ostream& theStream )
{
...
// For Display
istream& CFG_OduCritical::ReadObject( istream& theStream )
{
...
FC_Stream& CFG_OduCritical::WriteObjectBinary( FC_Stream& theStream )
{
...
// For persitance and region transfer
FC_Stream& CFG_OduCritical::ReadObjectBinary( FC_Stream& theStream )
{
...
FC_CmdProcessor::STATUS CFG_OduCritical::Set(int argc, char **argv)
{
    int  aMaxBufLen = 31;
    char aParam[32];
...
void CFG_OduCritical::Display( FC_Stream& theStream )
{
    uint32 aOduIdentifier = myOduIdentifier.GetIdValue();
    theStream   << "ODU CRIT - Odu ID               [oduid]     = 0x " << hex << aOduIdentifier << myOduIdentifier.DisplayOduIdentifier() << endl;
    ...
    theStream   << "ODU CRIT - Odu Object Type      [type]      = " << DISPLAY_ODU_OBJECT_TYPE(myInstanceObjectType)  << endl;
    /*
    ...
    theStream   << endl;
    */
    theStream   << "ODU CRIT - Odu Terminating      [oduterm]   = " << DISPLAY_BOOL(GetIsOduTerm())  << endl;
    ...
    theStream   << "ODU CRIT - TXPayload Load Type  [psi]       = 0x " << hex << (uint32)myTxPayloadType << dec << endl;
    theStream   << "ODU CRIT - Clock Type           [clocktype] = " << DISPLAY_CLOCK_TYPE(myClockType) << endl;
    //theStream   << "ODU      - Terminated Indication[termindi]  = " << DISPLAY_ODU_INDICATION(myTerminatedIndication) << endl;
    theStream   << "ODU CRIT - Trib Slot Size       [tribsize]  = " << DISPLAY_TS_SIZE(myTribSize) << endl;
    theStream   << "ODU CRIT - Trib Port            [tribport]  = 0x " << hex << (uint32)myTribPort << dec << endl;
    ...
    theStream   << "ODU CRIT - Expected SignalRate  [exprate]   = " << dec << myExpSigRate << dec << endl;
