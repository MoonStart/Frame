...
--------------------------------------------------------------------------*/
#ifndef PM_BBINHIBITHOPFAREND_H
#define PM_BBINHIBITHOPFAREND_H

#include <PM/PM_BbInhibit.h>
#include <EPM/PM_TypeHopFarEnd.h>


class PM_BbInhibitHopFarEnd : public PM_BbInhibit
{

public:

    //Class default constructor.
    PM_BbInhibitHopFarEnd (uint32 dummy1 = 0, uint32 dummy2 = 0);

    //Class default destructor.
    virtual ~PM_BbInhibitHopFarEnd();
...
protected:
    ...
    PM_ResetCounter myPrivateResetCountCurrent[PM_TypeHopFarEnd::PM_PARAM_NUM];

};

#endif //PM_BBINHIBITHOPFAREND_H
