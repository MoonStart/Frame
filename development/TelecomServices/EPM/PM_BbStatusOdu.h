...
#ifndef PM_BBSTATUSODU_H
#define PM_BBSTATUSODU_H
...
//status information. 
class PM_BbStatusOdu : public FC_BbObject
{
public:
...
//-----------------------------------------------------------------
inline uint32 PM_BbStatusOdu::GetPSC() const
{
    return myPSCCounter.GetCount();
}

//-----------------------------------------------------------------
inline uint32 PM_BbStatusOdu::GetPSD() const
{
    return myPSDCounter.GetCount();
}

//-----------------------------------------------------------------
inline bool PM_BbStatusOdu::EverPresentRevertiveMode()
{
	return  myCurrentRevertiveMode;
}

//-----------------------------------------------------------------
inline bool PM_BbStatusOdu::EverRemovedFromProtectionScheme()
{
...
//-----------------------------------------------------------------
inline bool PM_BbStatusOdu::EverPresentInProtectionScheme()
{
    return myCurrentProtectionShemePrsenceStatus;
}

//-----------------------------------------------------------------
inline bool PM_BbStatusOdu::EverChangedProtectionScheme()
{
...
//-----------------------------------------------------------------
inline bool PM_BbStatusOdu::EverChangedRevertiveMode()
{
