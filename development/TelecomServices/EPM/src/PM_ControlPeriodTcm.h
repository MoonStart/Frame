...
#ifndef PM_CONTROLPERIODTCM_H
#define PM_CONTROLPERIODTCM_H
...
class PM_ControlPeriodTcm : public PM_ControlPeriod
{
public:

    //Class default constructor.
    PM_ControlPeriodTcm(PM_GenericApplication      &theGenericApplication,
