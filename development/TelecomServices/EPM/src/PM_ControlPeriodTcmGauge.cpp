...
PM_ControlPeriodTcmGauge::PM_ControlPeriodTcmGauge (PM_GenericApplication     &theGenericApplication,
...
PM_ControlPeriodTcmGauge::~PM_ControlPeriodTcmGauge()
{
    // Nothing to do for now.
...
//-----------------------------------------------------------------
void PM_ControlPeriodTcmGauge::ControlPeriod(long theCurrentTimeChanged, FC_Time theCurrentTime,
...
void PM_ControlPeriodTcmGauge::SwitchOnPeriod(FC_Time theCurrentPeriod)
{
    if (myWarning)
    {
    ...
    PM_BbValueTcmGauge& currentValue = dynamic_cast<PM_BbValueTcmGauge&>((*GetCurrentValueRegion())[myDynamicIndex]);
    ...
    PM_BbValueTcmGauge& previousValue = dynamic_cast<PM_BbValueTcmGauge&>((*GetPreviousValueRegion())[myIndex]);
...
void PM_ControlPeriodTcmGauge::StartNewCurrentPeriod(FC_Time newCurrentPeriod, bool theInvalidFlag)
{
