...
Copyright(c) Tellabs Transport Group. All rights reserved
 ...
 DESCRIPTION:   The class to update OTU PM gauges .
--------------------------------------------------------------------------*/

#ifndef PM_RULESOTUGAUGE_H
#define PM_RULESOTUGAUGE_H
...
//OTU Gauge layer. These accumulation rules are deduced from
...
class PM_RulesOtuGauge :  public PM_Rules
{
public:

    //Class default constructor.
    PM_RulesOtuGauge(PM_GenericApplication& theGenericApplication,                      
                     uint16 theIndex);

    //Class default destructor.
    virtual ~PM_RulesOtuGauge();

    //Initializes rules at beginning of execution or after
    //context becomes available.
    virtual void Init();

    //Updates the accumulation rules for OTU Gauges. This 
...
private:
    ...
    PM_BbStatusOtuGauge& myStatusOtuGauge;
