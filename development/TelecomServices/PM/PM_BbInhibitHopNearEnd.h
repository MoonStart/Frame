...
--------------------------------------------------------------------------*/
#ifndef PM_BBINHIBITHOPNEAREND_H
#define PM_BBINHIBITHOPNEAREND_H

#include <PM/PM_BbInhibit.h>
#include <PM/PM_TypeHopNearEnd.h>


class PM_BbInhibitHopNearEnd : public PM_BbInhibit
{

public:

    //Class default constructor.
    PM_BbInhibitHopNearEnd (uint32 dummy1 = 0, uint32 dummy2 = 0);

    //Class default destructor.
    virtual ~PM_BbInhibitHopNearEnd();
    ...
    PM_ResetCounter GetPrivateResetCountCurrent(PM_TypeHopNearEnd::PM_Param theType) { return myPrivateResetCountCurrent[ theType ]; }
    void SetPrivateResetCountCurrent(PM_TypeHopNearEnd::PM_Param theType, PM_ResetCounter theResetCounter) 
...
protected:
    ...
    PM_ResetCounter myPrivateResetCountCurrent[PM_TypeHopNearEnd::PM_PARAM_NUM];

};

#endif //PM_BBINHIBITHOPNEAREND_H
