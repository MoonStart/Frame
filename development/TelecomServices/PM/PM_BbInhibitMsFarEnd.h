...
--------------------------------------------------------------------------*/
#ifndef PM_BBINHIBITMSFAREND_H
#define PM_BBINHIBITMSFAREND_H

#include <PM/PM_BbInhibit.h>
#include <PM/PM_TypeMsFarEnd.h>


class PM_BbInhibitMsFarEnd : public PM_BbInhibit
{

public:

    //Class default constructor.
    PM_BbInhibitMsFarEnd (uint32 dummy1 = 0, uint32 dummy2 = 0);

    //Class default destructor.
    virtual ~PM_BbInhibitMsFarEnd();
...
protected:
    ...
    PM_ResetCounter myPrivateResetCountCurrent[PM_TypeMsFarEnd::PM_PARAM_NUM];

};

#endif //PM_BBINHIBITMSFAREND_H
