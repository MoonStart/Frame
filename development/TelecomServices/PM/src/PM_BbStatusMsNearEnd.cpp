...
#include <PM_BbStatusMsNearEnd.h>
#include <BaseClass/FC_TextStream.h>

//-----------------------------------------------------------------
PM_BbStatusMsNearEnd::PM_BbStatusMsNearEnd ()  :
...
//-----------------------------------------------------------------
void PM_BbStatusMsNearEnd::Update(SP_SwitchingStatistic* theSpStat) 
{
...
//-----------------------------------------------------------------
ostream& PM_BbStatusMsNearEnd::WriteObject( ostream& theStream )
{
...
//-----------------------------------------------------------------
istream& PM_BbStatusMsNearEnd::ReadObject( istream& theStream )
{
    return theStream >> myPSCCounter
                     >> myPSDCounter
...
//-----------------------------------------------------------------
void PM_BbStatusMsNearEnd::Init(restart_type theRestart)
{
    // Nothing to do for now.
