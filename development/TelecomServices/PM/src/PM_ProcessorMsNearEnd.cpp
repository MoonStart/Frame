...
#include <PM/PM_ProcessorMsNearEnd.h>


//-----------------------------------------------------------------
// Class constructor.
PM_ProcessorMsNearEnd::PM_ProcessorMsNearEnd(PM_GenericApplication& theGenericApplication,
                                             uint16                 theNumberOfPort):
    PM_Processor(theGenericApplication, theNumberOfPort, PM_MS_NE_STRING)
{
...
//-----------------------------------------------------------------
PM_ProcessorMsNearEnd::~PM_ProcessorMsNearEnd ()
{
    // Nothing to do for now.
...
//-----------------------------------------------------------------
void PM_ProcessorMsNearEnd::CreateActionsInstances()
{
    ...
    for (uint32 portNumber = 0; portNumber < myNumberOfPort; portNumber++)
    {
        ...
        myRules.push_back(new PM_RulesMsNearEnd(myGenericApplication, (uint16)portNumber));

        // Create an Accumulation Period instance for 15 MINUTE period.
        myAccPeriod15m.push_back(new PM_AccumulationPeriodMsNearEnd(myGenericApplication,
                                                               PM_TypeMsNearEnd::GetMaxValueTableMsNearEnd15M(),
                                                               *myRules[portNumber],
                                                               portNumber,
        ...
        myAccPeriodDay.push_back(new PM_AccumulationPeriodMsNearEnd(myGenericApplication,
                                                               PM_TypeMsNearEnd::GetMaxValueTableMsNearEndDay(),
                                                               *myRules[portNumber],
                                                               portNumber,
                                                               CT_PM_PERIOD_1_DAY));
