...
setenv DEVROOT ${WRL_P2041_PLAT_ROOT}/build/rootfs/tlab_p2041
setenv SYSROOT ${DEVROOT}/export/sysroot/tlab_p2041-glibc_small/sysroot
setenv TOOLCHAIN ${DEVROOT}/export/sysroot/tlab_p2041-glibc_small/x86-linux2
setenv TOOLCHAINPATH ${DEVROOT}/export/export-toolchain/toolchain/x86-linux2/bin
...
setenv WRL_PLAT_USR_LIB ${DEVROOT}/export/sysroot/tlab_p2041-glibc_small/sysroot/usr/lib
...
setenv PATH "${TOOLCHAIN}:${TOOLCHAINPATH}:${SYSROOT}:${ENV_ORIGINAL_PATH}:${HOST_TOOLS}"
