...
export WRL_P2041_PKG_DIR=/vobs/ots/wrlplat/tlab_p2041
export FSS_PSS_ROOT=/vobs/ots/pss/fss
export FSS_PTS_ROOT=/vobs/ots/pts/fss
export XEL_ROOT=/vobs/ots/pss/xelerated/mea_d240t
...
export WIND_GNU_PATH=$WIND_HOME/gnu/4.1.2-vxworks-6.7
export WIND_JRE_PATH=$WIND_HOME/jre/1.4.2
export WIND_BASE=$WIND_HOME/vxworks-6.7
export WIND_TOOLS=$WIND_HOME/workbench-3.1
export WIND_DFW_PATH=$WIND_TOOLS/dfw/0109h
export WIND_WRWB_PATH=$WIND_TOOLS/wrwb/
export WIND_USR=$WIND_BASE/target/usr
export WIND_FOUNDATION_PATH=$WIND_TOOLS/foundation

#
# set up library path for tclsh
#
export LD_LIBRARY_PATH=${WIND_FOUNDATION_PATH}/${WIND_HOST_TYPE}/lib:${LD_LIBRARY_PATH}
...
export WR_UTIL=$WIND_HOME/utilities-1.0/$WIND_HOST_TYPE/bin
...
export VXWRK_IPNET=$WIND_HOME/components/ip_net2-6.7
